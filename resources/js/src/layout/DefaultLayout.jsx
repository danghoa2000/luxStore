            ...
            >
                <div className="cart__product__list">
                    <div style={{ margin: "0 20px", height: 74, display: "flex", alignItems: 'center' }}>
                        <ShoppingCart />
                        <Typography variant="h6" style={{ marginLeft: 10 }}>{CartItem?.length} Item</Typography>
                    </div>
                    ...
                    {CartItem?.length > 0 ? CartItem.map((item) => {
                        ...
                        : <img src="https://shop.unicornstore.in/beam/themes/2019/assets/img/cart_empty.png" style={{ display: 'block', margin: 'auto' }} alt="" />
                    }
