            ...
            <div className="card__admin">
                ...
                <Grid container sx={{ margin: 0, padding: 1, width: '100%' }} spacing={10}>
                    <Grid item xs={6}>
                            ...
                            render={({ field }) =>
                                <FormControl variant="standard">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t('placehoder', { name: t('group_category.list.table.group_category_code') })}
                                        onBlur={(event) => {
                        ...
                        />
                        {errors.group_category_code && <p className='text-danger'>{errors.group_category_code.message}</p>}
                            ...
                            render={({ field }) =>
                                <FormControl variant="standard">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t('placehoder', { name: t('group_category.list.table.name') })}
                                        onBlur={(event) => {
                                            setValue(event.target.id, event.target.value ? event.target.value.trim() : '')
                                        }}
                                    />
